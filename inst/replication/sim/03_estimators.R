...
#
# Usage:
#   Rscript inst/replication/sim/03_estimators.R                       # data-driven (default)
#   Rscript inst/replication/sim/03_estimators.R --n 500               # single n
#   Rscript inst/replication/sim/03_estimators.R --trim 0.15           # override: fixed symmetric
#   Rscript inst/replication/sim/03_estimators.R --uniform-trim        # PG_TRIM_DEFAULT symmetric
#
# =============================================================================

source("inst/replication/sim/00_config.R")
source("inst/replication/shared/04_estimators.R")  # compute_dd_wald, compute_dd_tc
