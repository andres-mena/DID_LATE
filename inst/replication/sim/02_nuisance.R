...
#
# Usage:
#   Rscript inst/replication/sim/02_nuisance.R              # all N_VALUES (Lasso, default)
#   Rscript inst/replication/sim/02_nuisance.R --n 500      # single n
#   Rscript inst/replication/sim/02_nuisance.R --method rf   # Random Forest
#   Rscript inst/replication/sim/02_nuisance.R --method nn   # Neural Network
#   Rscript inst/replication/sim/02_nuisance.R --test       # 20 reps at n=500
#
# =============================================================================
